...
public class InitDb {
    ...
    static class InitService{
        ...
        public void dbInit(){
            ...
            part_timer1.setHope_jobType(JobType.배달);
            part_timer1.setHopeWage(10000);
            part_timer1.setStatus(new Stats(4,5,4,4));
            part_timer1.setSexuality(Part_timer_sexuality.MALE);
            part_timer1.setAddress(new Address("인천","인하로","100","하이테크센터12층"));

            Part_timer part_timer2 = new Part_timer();
            part_timer2.setName("알바생2");
            part_timer2.setAge(22);
            part_timer2.setHope_jobType(JobType.매장관리);
            part_timer2.setHopeWage(11000);
            part_timer2.setStatus(new Stats(4,3,5,4));
            part_timer2.setSexuality(Part_timer_sexuality.FEMALE);
            part_timer2.setAddress(new Address("인천","인하로","100","하이테크센터12층"));
            ...
            part_timer3.setStatus(new Stats(4,4,4,4));
